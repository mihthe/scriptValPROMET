...
plot_data_100 <- plot_data[1:100, ]

# order by surface for first analysis
plot_data_surface <- plot_data_100[order(plot_data_100$surface), ]
...
plot(plot_data_surface$x_position, plot_data_surface$difference, 
     ...
     col = ifelse(plot_data_surface$difference > 0, 
                  ...
                  alpha("#E74C3C", 0.6)),
     xlab = "", 
     ylab = "Signed Difference (λ - y)",
     main = "A) Signed Prediction Error (Ordered by Biopsy Surface)",
     bty = "l",
